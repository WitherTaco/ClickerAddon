...
namespace ClickerAddon
{
	...
	internal static class ClickerCompat
	{
		...
		public static void SetEffectW(Item item, string effect, int amount)
		{
		...
		public static void SetArmorSet(Player player, string set)
		{
			ClickerClass?.Call("SetArmorSet", versionString, player, set);
		}
