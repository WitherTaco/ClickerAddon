...
namespace ClickerAddon.Tiles
{
	public class MiceChest : ModTile
	{
		public override void SetDefaults()
		{
			...
			chest = "Mice Chest";
			chestDrop = mod.ItemType("MiceChest");
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.showItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Mice Chest";
				if (player.showItemIconText == "Mice Chest")
				{
					player.showItemIcon2 = mod.ItemType("MiceChest");
