...
namespace ClickerAddon.Items.CrossContent.Example.Weapons.Clickers
{
	...
	public class ExampleClickerWithEffect : ModItem
	{
		...
		{
			return WitherTacoLib.IfMod("ExampleMod");
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(exampleMod.ItemType("ExampleItem"), 10);
